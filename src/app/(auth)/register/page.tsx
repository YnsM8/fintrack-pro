      ...
      <div ref={containerRef} className="w-full max-w-md rounded-2xl bg-slate-900 p-8 shadow-2xl border border-slate-800">
        ...
        {success ? (
          <div className="space-y-6">
            <div className="bg-emerald-950/40 border border-emerald-800 text-emerald-300 p-4 rounded-xl text-sm leading-relaxed text-center">
              <strong>¡Registro casi completo!</strong><br />
              Te hemos enviado un correo de confirmación. Por favor, verifica tu bandeja de entrada (y la carpeta de spam) para confirmar tu cuenta y poder iniciar sesión.
            </div>
            <a href="/login" className="block w-full bg-blue-600 hover:bg-blue-700 text-white font-bold p-2.5 rounded-lg transition-colors text-center">
              Ir a Iniciar Sesión
            </a>
          </div>
        ) : (
